        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              csv = _context.sent;
              list = parseCsv(csv);
              sortKeywords(list, 'html').forEach(function (item) {
                var pathname = trim$1(item.path);
                var html = trim$1(item.html);
                var trans = trim$1(item.trans);
                var times = item.times | 0 || 1;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _context.prev = 7;
              _iterator = htmlMap.entries()[Symbol.iterator]();
